...
/**
 * This class provides a wrapper for network errors when making requests to Cleemy Expenses
 */
export class LuccaCleemyExpensesError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "LuccaCleemyExpensesError";
